...
namespace TestStackAndQueue
{
    public class UnitTest1
    {
        ...
        public PseudoQueue TestPseudoQueue = new PseudoQueue();
        //1- Test PseudoEnqueue
        [Fact]
        public void TestPseudoEnqueue()
        {
            ...
            Assert.Equal(20, TestPseudoQueue.Peek());
        ...
        public void TestPseudoDequeue()
        {
            ...
            TestPseudoQueue.Enqueue(15);
            TestPseudoQueue.Enqueue(10);
            Assert.Equal(20, TestPseudoQueue.Dequeue());

        }
        //3- test peek 
        [Fact]
        public void TestPseudoPeek()
        {
            TestPseudoQueue.Enqueue(30);
            TestPseudoQueue.Enqueue(40);
            TestPseudoQueue.Enqueue(50);
            Assert.Equal(30, TestPseudoQueue.Peek());

        }
        //4-  test PseudoEnqueue in empty stack
        [Fact]
        public void TestPseudoEnqueueOnEmptyStack()
        {
            PseudoQueue TestPseudoQueue2 = new PseudoQueue();
            TestPseudoQueue2.Enqueue(20);
            Assert.Equal(20, TestPseudoQueue2.Peek());

        }

        // 5- test Pseudo DequeueOn EmptyStack
        [Fact]
        public void TestPseudoDeQueueEmptyStack()
        {
            Assert.Throws<Exception>(() => TestPseudoQueue.Dequeue());
        }
